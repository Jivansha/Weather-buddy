...
String apiKey = "H09MYLSVNYR8HT9Z";     //  Enter your Write API key from ThingSpeak

const char *ssid =  "tqb-WiFi";     // replace with your wifi ssid and wpa2 key
const char *pass =  "thingQbator123";
